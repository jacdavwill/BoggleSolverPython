...
print("     1) When prompted for your board layout, enter each of the letters \n        on your board without spaces.")
print("     2) Enter the letters from the left to the right, from the top to\n        the bottom. Just like you are reading.")
